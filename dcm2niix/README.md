...
### Download the latest [Development version](https://ci.appveyor.com/project/neurolabusc/dcm2niix)
The above link provides pre-compiled development version of dcm2niix on Winodows, MacOS, Linux (click on the **Artifacts** button).
